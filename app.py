...
if choice=="Modelling":
    ...
    if st.button('Diabetes Test Result'):
        diagnosis = diabetes_prediction(
            ["Gender","Married","customer_type","age","type_of_travel","customer_class","flight_distance","inflight_wifi_service","departure_arrival_time_convenient","ease_of_online_booking","gate_location","food_and_drink","online_boarding","seat_comfort","inflight_entertainment","onboard_service","leg_room_service","baggage_handling","checkin_service","inflight_service","cleanliness","departure_delay_in_minutes","arrival_delay_in_minutes","satisfaction"])
    # [Male, No, Loyal
    # Customer, 13, Personal
    # Travel, Eco
    # Plus, 460, 3, 4, 3, 1, 5, 3, 5, 5, 4, 3, 4, 4, 5, 5, 25, 18, neutral or dissatisfied
